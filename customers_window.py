...
class CustomersFrame(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.search_entry.bind("<KeyRelease>", lambda event: self.load_customers())
        ...
        self.dashboard_frame.pack_forget() # Hide it initially
    ...
    def add_customer(self):
        ...
        if conn and cursor:
            try:
                # We save empty string for notes by default
